...
$.zoom_details_a.addEventListener('updateDetails', function(e) {
	$.zoom_details_a.likes_count = Alloy.Globals.data.media[Alloy.Globals.ui.zoom_index]['likes']['count'];
	$.zoom_details_a.tag_count = Alloy.Globals.data.media[Alloy.Globals.ui.zoom_index]['tags'].length;
